  ...
  return (
    <div classname="overflow-x-hidden">
      ...
      <div className='flex flex-col items-center justify-center pb-10 mx-2'>
        ...
        <iframe className='p-3'  width="500" height="315" src="https://www.youtube.com/embed/XiAqmlIEFi0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
